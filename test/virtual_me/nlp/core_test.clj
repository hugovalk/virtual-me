...
(fact "tokenize splits text in its separate tokens"
  (:tokens (tokenize (dutch "Een hele mooie Nederlandse zin.") => ["Een" "hele" "mooie" "Nederlandse" "zin" "."]))
  (:tokens (tokenize (english "A very nice sentence in English.") => ["A" "very" "nice" "sentence" "in" "English" "."])))
